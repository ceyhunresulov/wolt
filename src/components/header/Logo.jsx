...
function Logo({ address, logoColor, customerBox }) {
  ...
  return (
    <div className="1/4 md:w-1/3 flex-1 md:flex items-center relative">
      ...
      >
        <div className="flex items-center  sm:w-tablet w-desktop md:w-auto">
          <div className="bg-bgFirst hover:bg-bgFirstHover w-8 h-8 lg:w-10 lg:h-10 rounded-full flex items-center justify-center  transition ease-linear duration-200">
