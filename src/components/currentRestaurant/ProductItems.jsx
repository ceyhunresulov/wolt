...
function ProductItems({ product, restId }) {
  return (
    <div className="relative h-36 sm:h-40 lg:w-full lg:h-48 flex justify-center box-border py-5 lg:py-7 cursor-pointer">
         ...
         <div className="h-full flex flex-col justify-between">
           ...
           <div className="text-sm sm:text-base">
             ...
             <span className="text-secondaryColor line-through">
               {product.price.find((item) => item.id === restId)?.value + 2.5} AZN
             </span>
           </div>
         </div>
